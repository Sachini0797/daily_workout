              ...
              <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                  ...
                  <form action="" class="form-submit">
                    ...
                    $value = $row['code'];
                    if ($id == 0) {
                      echo "<span text-center'><a class='btn btn-success' href='../login/login.php''><i class='fas fa-receipt'></i>&nbsp;&nbsp;View More</a></span>";
                    } else {
                      echo "<span text-center'><a class='btn btn-success' href='./allFoodItems.php?type=view&code=" . $row['code'] . "'><i class='fas fa-receipt'></i>&nbsp;&nbsp;View Products</a></span>";
                    }
                    ?>
