...
if ($type == 'delete') {
  ...
  echo "<script type='text/javascript'> document.location = './Fooditems.php?id=" . $id . "; </script>";
}
    ...
    <div class="container">
            ...
            <tbody>
              ...
              <tr>
                ...
                while ($row = mysqli_fetch_assoc($res)) { ?>
                  ...
                  <td><img src="./assets1/fooditem<?php echo $row['image'] ?>"> </td>
                  <td><?php echo $row['description'] ?></td>
                  <td><?php echo $row['price'] ?></td>
                  <td>
                    <?php

                    echo "<a href='./newFoodItems.php?type=edit&id=" . $row['id'] . "'><button type='button' class='btn btn-success'>Edit</button></a>";
                    echo "<a href='./Fooditems.php?&id=" . $id . "&type=delete&fid=" . $row['fid'] . "'><button type='button' class='btn btn-danger'>Delete</button></a>";
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php echo "<a class='btn btn-warning'  href='./newFoodItems.php?&id=" . $id . "'>Add Menu Item</a>"; ?>
