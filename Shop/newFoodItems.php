...
if ($id == 0) {
  ...
  if (isset($_POST['add'])) {
    ...
    if ($_FILES['image']['name']) {
      move_uploaded_file($_FILES['image']['tmp_name'], "./assets1/foodItem/" . $_FILES['image']['name']);
    ...
    $sql2 = "INSERT INTO products (rid, restuarantName, name, image, description, price, code , qty) 
            VALUES ('$id','$resname','$name','$img','$description', $price , '$code', '$qty') ";
              ...
              <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                    ...
                    <?php echo "<a class='nav-link'  href='../Shop/profile.php?&id=" . $id . "'>Restaurant</a>"; ?>

                  </li>
                  <li class="nav-item">
                    <!-- <a class="nav-link" href="../Restuarant/Fooditems.php">Menu Items</a> -->
                    <?php echo "<a class='nav-link'  href='../Shop/Fooditems.php?&id=" . $id . "'>Menu Items</a>"; ?>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    ...
                    <?php echo "<a class='nav-link'  href='../Shop/promotions.php?&id=" . $id . "'>Manage Promotions</a>"; ?>
                  </li>
                  <li class="nav-item">
                    <!-- <a class="nav-link" href="./editdetails.php">Edit Resturant</a> -->
                    <?php echo "<a class='nav-link'  href='../Shop/editdetails.php?&id=" . $id . "'>Edit Resturant</a>"; ?>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <form id="contact" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  <fieldset>
                    <input id="name" type="text" placeholder="Food Item Name" name="name" required>
                  </fieldset>
                </div>
                <div class="col-md-6 col-sm-12">
                  <fieldset>
                ...
                <div class="col-lg-12">
                  <fieldset>
                    <button type="submit" id="form-submit" name="add" class="main-button">Add Food Item</button>
